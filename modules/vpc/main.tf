...
resource "aws_route" "private_route1_to_vpc" {
  ...
  destination_cidr_block    = data.aws_vpc.other_vpc[0].cidr_block      # Substitua pelo CIDR da VPC2
...
resource "aws_route" "public_route_to_other_vpc" {
...
resource "aws_route" "private_route_to_other_vpc" {
